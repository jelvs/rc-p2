...
public class HTTPServer {
	...
	static InputStream notSupportedPageStream() {
		final String page = "<HTML><BODY>Request Not Supported</BODY></HTML>";
	...
	/**
	 * Returns an input stream with a very simple valid page with the text of the
	 * input
	 */
	 ...
	 * 
	 */
	static void sendFile(String fileName, OutputStream out) throws IOException {
